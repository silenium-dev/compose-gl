...
private class GLCanvasRenderer(
    ...
    val onDispose: () -> Unit,
) : GLSurfaceView.Renderer, GLProcAddressProvider {
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        val scope = GLDrawScopeImpl(FBOScopeImpl(fbo ?: return log.error("No FBO")), this, delta)
        scope.drawGL {
            scope.render()
        }
    ...
    override fun getGlProcAddress(name: String): Long = EGLNative.eglGetProcAddress(name)
